...
const handleSearch = (query: string) => {
  if (query.trim() === '') {
    ...
    const filtered = initialEnquiries.filter(enquiry => 
...
<div className=" flex items-center justify-between bg-gray-150 p-4">
    ...
    <div className="flex items-center space-x-2">
        ...
        <div className="container mx-auto px-2">
          ...
          />
<div className={`w-full relative rounded-2xl p-5 flex items-center justify-between overflow-hidden mb-4 bg-white border border-gray-200 shadow-md`}>  <div className="flex space-x-2">
    <ExportButton />
    <FilterButton />
  </div>
...
<SearchButton onSearch={handleSearch} />
  ...
  render: (enquiry) => {
    ...
    const handleStatusChange = (newStatus: 'complaint' | 'Sales') => {
    ...
    return (
      ...
      >
        ...
        >
          {/* Glow effect (smaller) */}
          <span className={`absolute -inset-0.25 rounded-full opacity-0 group-hover:opacity-50 blur-[2px] transition duration-200 ${
            enquiry.status === 'complaint' ? 'bg-green-200' : 'bg-blue-200'
          }`}></span>
          ...
          <div className="flex items-center space-x-1.5 relative">
            ...
            <span className="relative flex h-2 w-2">
              ...
              <span className={`relative inline-flex rounded-full h-2 w-2 ${
                enquiry.status === 'complaint' ? 'bg-green-600' : 'bg-blue-600'
              }`}></span>
            </span>
        ...
        {isOpen && (
          <div
            className="origin-top-left absolute left-0 mt-1 w-80 rounded-xl shadow-lg bg-white border border-gray-200 z-50 transition-all duration-200 ease-out"
          >
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-y-3 gap-x-2 text-sm">
                <div className="text-gray-500 col-span-1">Assigned To:</div>
                <div className="font-medium col-span-2 text-gray-800">
                  <span className="inline-flex items-center">
                    {assignedTo || <span className="text-gray-400">Unassigned</span>}
                  </span>
                </div>

                <div className="text-gray-500 col-span-1">Assigned On:</div>
                <div className="font-medium col-span-2 text-gray-800">
                  <span className="inline-flex items-center">
                    {new Date().toLocaleString()}
                    <svg className="ml-1.5 h-3.5 w-3.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </span>
                </div>

                <div className="text-gray-500 col-span-1">Urgency:</div>
                <div className="font-medium col-span-2 text-gray-800">
                  <div className="flex space-x-2">
                    <button
                ...
                <div className="text-gray-500 col-span-1">Notes:</div>
                <div className="font-medium col-span-2 text-gray-800">
              ...
              <div className="grid grid-cols-3 gap-2 pt-2">
                ...
                {/* View Button */}
                <button
                  className="px-3 py-2 text-xs font-medium rounded-lg transition-all duration-200 flex items-center justify-center space-x-1 bg-gray-50 text-gray-700 border border-gray-200 hover:bg-gray-100"
                >
                  <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                render: (enquiry) => {
                  ...
                  return (
                    <div className="relative group">
                      ...
                      {/* Dropdown modal */}
                      <div
                        className={`absolute z-[100] w-64 bg-white shadow-xl rounded-lg overflow-hidden border border-gray-100 mt-1 left-0 transition-all duration-200 ease-out ${isOpen ? 'opacity-100 visible scale-100' : 'opacity-0 invisible scale-95'
                          }`}
                        onMouseEnter={() => setIsOpen(true)}
                        onMouseLeave={() => setIsOpen(false)}
                      >
                        ...
                        <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-3">
                          <h3 className="font-semibold text-sm uppercase tracking-wider">Phone Actions</h3>
                        </div>
                        ...
                        <div className="flex flex-col p-2 space-y-1">
                          ...
                          >
                            <div className="relative">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-blue-600 group-hover:animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                              </svg>
                            </div>
                            <div>
                              <div className="font-medium text-gray-800 group-hover:text-blue-700">Call Now</div>
                              <div className="text-xs text-gray-500 group-hover:text-blue-600">{enquiry.phone}</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-auto text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          >
                            <div className="relative">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-gray-600 group-hover:text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span className="font-medium text-gray-800 group-hover:text-purple-700">Copy Number</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-auto text-gray-400 group-hover:text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            </svg>
                          </button>
                          ...
                          >
                            <div className="relative">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-green-600 group-hover:animate-bounce" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <span className="font-medium text-gray-800 group-hover:text-green-700">WhatsApp Message</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-auto text-gray-400 group-hover:text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            </svg>
                          </a>
                        </div>
